...
func CreateReportsTable(database *sql.DB) {
	// `reports` tablosunu oluşturma SQL komutu
	createTableSQL := `
...
func CreateFeedbackTable(database *sql.DB) {
	// `feedback` tablosunu oluşturma SQL komutu
	createTableSQL := `
